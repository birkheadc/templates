...
import { CameraIcon, EyeDropperIcon, FilmIcon, HomeIcon, MapIcon, MapPinIcon, SwatchIcon } from '@heroicons/react/24/outline';
...
export default function NavLinks(props: NavLinksProps): JSX.Element {
  return (
    <ul className='absolute flex flex-row w-full h-full'>
      ...
      <NavLink id='parallax'><FilmIcon height={'100%'} /> <span className='hidden lg:inline-block'>parallax</span></NavLink>
    </ul>
  );
}